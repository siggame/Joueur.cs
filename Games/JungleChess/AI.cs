...
{
    /// <summary>
    /// This is where you build your AI for JungleChess.
    /// </summary>
    public class AI : BaseAI
    {
        ...
        public override string GetName()
        {
            ...
            return "JungleChess C# Player"; // REPLACE THIS WITH YOUR TEAM NAME!
        ...
        /// </summary>
        /// <returns>A string formatting for the move you want to make. If the move is invalid or not properly formatted you will lose the game.</returns>
